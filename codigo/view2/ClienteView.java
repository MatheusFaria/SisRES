...
public class ClienteView extends javax.swing.JDialog {
    ...
    private Vector<String> fillDataVector(Professor prof) {
        ...
        nomesTabela.add(prof.getMatricula());
        nomesTabela.add(prof.getNome());
        nomesTabela.add(prof.getTelefone());
        nomesTabela.add(prof.getCpf());
        nomesTabela.add(prof.getEmail());
    ...
    private DefaultTableModel fillTable(){
        try {
            ...
            while(i.hasNext()){
                ...
                table.addRow(fillDataVector(prof));
            }
    ...
    private void pesquisarBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_pesquisarBtnActionPerformed
        JOptionPane.showMessageDialog(this, "Funciona", "Erro", JOptionPane.ERROR_MESSAGE, null);
