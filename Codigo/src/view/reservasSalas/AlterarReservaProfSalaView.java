...
public class AlterarReservaProfSalaView extends ReservaSalaView{
	...
	public AlterarReservaProfSalaView(Frame parent, boolean modal, int index, String data) throws SQLException, PatrimonioException, PatrimonioException, ClienteException, ReservaException {
		super(parent, modal);
