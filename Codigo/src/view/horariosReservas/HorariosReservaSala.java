...
public class HorariosReservaSala extends HorariosReservaPatrimonio {
	...
	protected void cancelarReservaAction(int index) {
		try {
            ...
            }else if(tipoCliente.equals("Professor")){ int confirm = JOptionPane.showConfirmDialog(this, "Deseja mesmo excluir Reserva?\n"
                    + instanceProf.buscarPorData(data).get(index).toString(), "Excluir", JOptionPane.YES_NO_OPTION);
