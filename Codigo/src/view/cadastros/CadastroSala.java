...
public class CadastroSala extends CadastroPatrimonio {
	...
	protected void cadastroAction() {
		try {
			//JOptionPane.showMessageDialog(this, codigoTxtField.getText() + descricaoTextArea.getText() + capacidadeTxtField.getText(), "teste", JOptionPane.INFORMATION_MESSAGE, null);
