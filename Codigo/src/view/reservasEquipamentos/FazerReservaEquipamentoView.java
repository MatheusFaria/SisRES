...
public class FazerReservaEquipamentoView extends ReservaEquipamentoView{
	...
	public FazerReservaEquipamentoView(Frame parent, boolean modal, Equipamento e, String data) throws SQLException, PatrimonioException, PatrimonioException, ClienteException, ReservaException {
		super(parent, modal);
		this.equipamento = e;
	...
	protected void reservarProfessor() {
		try {
			...
			instanceProf.inserir(equipamento, prof,
