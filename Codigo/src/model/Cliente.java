...
public abstract class Cliente {
    ...
    public Cliente(String nome, String cpf, String matricula, String telefone, String email) throws ClienteException {
        this.setNome(nome);
        this.setCpf(cpf);
    ...
    public void setCpf(String cpf) throws ClienteException {
        if (cpf == null)
            ...
            if (this.validarCpf(cpf.split("[\\. | -]")[0] + cpf.split("[\\. | -]")[1] + cpf.split("[\\. | -]")[2]
                    + cpf.split("[\\. | -]")[3]))
                this.cpf = cpf;
            else
    ...
    public boolean equals(Cliente b) {
        if (this.getNome().equals(b.getNome()) && this.getCpf().equals(b.getCpf()) && this.getMatricula().equals(b.getMatricula())
                && this.getTelefone().equals(b.getTelefone()) && this.getEmail().equals(b.getEmail())) {
