...
public class ReservaSalaAluno extends ReservaSala {
    ...
    public ReservaSalaAluno(String data, String hora, Sala sala, String finalidade, String cadeiras_reservadas, Aluno aluno)
    ...
    public boolean equals(ReservaSalaAluno obj) {
        return (super.equals(obj) && this.getAluno().equals(obj.getAluno()) && this.getCadeiras_reservadas().equals(
                obj.getCadeiras_reservadas()));
    }
