...
public class ReservaEquipamentoProfessor extends ReservaEquipamento{
	...
	public ReservaEquipamentoProfessor(String data, String hora,
			Equipamento equipamento, Professor professor) throws ReservaException {
	...
	public boolean equals(ReservaEquipamentoProfessor obj) {
		return (super.equals(obj) &&
				this.getEquipamento().equals(obj.getEquipamento()));
	}

	@Override
	public String toString() {
		return "ReservaEquipamentoProfessor [professor=" + this.getEquipamento().toString()
