...
public class ReservaSalaProfessor extends ReservaSala {
    ...
    public ReservaSalaProfessor(String data, String hora, Sala sala, String finalidade, Professor professor)
    ...
    public boolean equals(ReservaSalaProfessor obj) {
        return (super.equals(obj) && this.getProfessor().equals(obj.getProfessor()));
    }

    @Override public String toString() {
        return "ReservaSalaProfessor [professor=" + this.getProfessor().toString() + ", toString()=" + super.toString() + "]";
    }
