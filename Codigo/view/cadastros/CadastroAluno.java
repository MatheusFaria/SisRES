	...
	public void cadastroAction() {
		try {
			if (cadastroBtn.getText().equals("Cadastrar")) {
				ManterAluno.getInstance().inserir(nomeTxtField.getText(), cpfTxtField.getText(),
					matriculaTxtField.getText(), telefoneTxtField.getText(), emailTxtField.getText());

				JOptionPane.showMessageDialog(this, "Aluno Cadastrado com sucesso", "Sucesso", JOptionPane.INFORMATION_MESSAGE, null);
